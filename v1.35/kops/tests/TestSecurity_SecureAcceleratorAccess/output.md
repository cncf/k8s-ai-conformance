...
## Checking that GPUs are available if requested


Creating test namespace "accelerator-requested-1774011601"


Applying manifest "testdata/accelerator-requested.yaml" to namespace "accelerator-requested-1774011601"
```bash
> kubectl apply -n accelerator-requested-1774011601 -f testdata/accelerator-requested.yaml
...
job.batch/accelerator-requested created

```

```bash
> kubectl wait -n accelerator-requested-1774011601 --for=condition=complete job/accelerator-requested --timeout=300s

```

```

job.batch/accelerator-requested condition met

```

```bash
> kubectl logs -n accelerator-requested-1774011601 job/accelerator-requested
...
<nvidia_smi_log>
	<timestamp>Fri Mar 20 13:00:11 2026</timestamp>
	...
	<gpu id="00000000:31:00.0">
		...
		<serial>1653623019067</serial>
		<uuid>GPU-8a0cb40d-f2e8-2199-64b0-33126c728d06</uuid>
		<pdi>0x71565eca46be451c</pdi>
		<minor_number>0</minor_number>
		<vbios_version>95.04.65.00.37</vbios_version>
		<multigpu_board>No</multigpu_board>
		<board_id>0x3100</board_id>
		<board_part_number>900-2G193-A800-001</board_part_number>
		...
		<pci>
			...
			<pci_bus_id>00000000:31:00.0</pci_bus_id>
			...
			<tx_util>341 KB/s</tx_util>
			<rx_util>244 KB/s</rx_util>
		...
		<temperature>
			...
			<gpu_temp_tlimit>53 C</gpu_temp_tlimit>
		...
		<gpu_power_readings>
			...
			<average_power_draw>16.78 W</average_power_draw>
			<instant_power_draw>16.78 W</instant_power_draw>
...
&check; GPUs were requested, and nvidia-smi reported available GPUs.



Deleting test namespace "accelerator-requested-1774011601"


Namespace deletion took 6s


## Checking that GPUs are not available if not requested


Creating test namespace "accelerator-not-requested-1774011622"


Applying manifest "testdata/accelerator-not-requested.yaml" to namespace "accelerator-not-requested-1774011622"
```bash
> kubectl apply -n accelerator-not-requested-1774011622 -f testdata/accelerator-not-requested.yaml

```

```

job.batch/accelerator-not-requested created

```

```bash
> kubectl wait -n accelerator-not-requested-1774011622 --for=condition=complete job/accelerator-not-requested --timeout=300s

```

```

job.batch/accelerator-not-requested condition met

```

```bash
> kubectl logs -n accelerator-not-requested-1774011622 job/accelerator-not-requested
...
nvidia-smi failed (as expected)

```

&check; No GPUs were requested, and nvidia-smi did not report any GPUs.



Deleting test namespace "accelerator-not-requested-1774011622"


Namespace deletion took 6s


## Pods with GPU requests should be isolated from each other


Creating test namespace "accelerator-isolation-1774011631"


Applying manifest "testdata/accelerator-isolation.yaml" to namespace "accelerator-isolation-1774011631"
```bash
> kubectl apply -n accelerator-isolation-1774011631 -f testdata/accelerator-isolation.yaml
...
resourceclaimtemplate.resource.k8s.io/single-gpu created
deployment.apps/accelerator-isolation-1 created
deployment.apps/accelerator-isolation-2 created

```

```bash
> kubectl wait -n accelerator-isolation-1774011631 --for=condition=available deployment/accelerator-isolation-1 --timeout=300s

```

```

deployment.apps/accelerator-isolation-1 condition met

```

```bash
> kubectl wait -n accelerator-isolation-1774011631 --for=condition=available deployment/accelerator-isolation-2 --timeout=300s

```

```

deployment.apps/accelerator-isolation-2 condition met

```

```bash
> kubectl logs -n accelerator-isolation-1774011631 deployment/accelerator-isolation-1

```

```

Fri Mar 20 13:00:33 UTC 2026
<?xml version="1.0" ?>
<!DOCTYPE nvidia_smi_log SYSTEM "nvsmi_device_v13.dtd">
<nvidia_smi_log>
	<timestamp>Fri Mar 20 13:00:33 2026</timestamp>
	<driver_version>580.105.08</driver_version>
	<cuda_version>13.0</cuda_version>
	<attached_gpus>1</attached_gpus>
	<gpu id="00000000:31:00.0">
...
Fri Mar 20 13:01:33 UTC 2026
<?xml version="1.0" ?>
<!DOCTYPE nvidia_smi_log SYSTEM "nvsmi_device_v13.dtd">
<nvidia_smi_log>
	<timestamp>Fri Mar 20 13:01:33 2026</timestamp>
	<driver_version>580.105.08</driver_version>
	<cuda_version>13.0</cuda_version>
	<attached_gpus>1</attached_gpus>
	<gpu id="00000000:31:00.0">
...
```bash
> kubectl logs -n accelerator-isolation-1774011631 deployment/accelerator-isolation-2

```

```

Fri Mar 20 13:01:38 UTC 2026
<?xml version="1.0" ?>
<!DOCTYPE nvidia_smi_log SYSTEM "nvsmi_device_v13.dtd">
<nvidia_smi_log>
	<timestamp>Fri Mar 20 13:01:38 2026</timestamp>
	<driver_version>580.105.08</driver_version>
	<cuda_version>13.0</cuda_version>
	<attached_gpus>1</attached_gpus>
	<gpu id="00000000:31:00.0">
		...
		<serial>1651324014917</serial>
		<uuid>GPU-c2f76b33-7953-256e-8f33-1343419b1a1c</uuid>
		<pdi>0xaec34080271c1b78</pdi>
		<minor_number>0</minor_number>
		<vbios_version>95.04.65.00.37</vbios_version>
		<multigpu_board>No</multigpu_board>
		<board_id>0x3100</board_id>
		...
		<clocks_event_reasons_counters>
			<clocks_event_reasons_counters_sw_power_cap>28805555 us</clocks_event_reasons_counters_sw_power_cap>
			<clocks_event_reasons_counters_sync_boost>0 us</clocks_event_reasons_counters_sync_boost>
			<clocks_event_reasons_counters_sw_therm_slowdown>0 us</clocks_event_reasons_counters_sw_therm_slowdown>
			<clocks_event_reasons_counters_hw_therm_slowdown>0 us</clocks_event_reasons_counters_hw_therm_slowdown>
			<clocks_event_reasons_counters_hw_power_brake>0 us</clocks_event_reasons_counters_hw_power_brake>
		...
		<temperature>
			...
			<gpu_temp_tlimit>47 C</gpu_temp_tlimit>
			<gpu_temp_max_tlimit_threshold>-5 C</gpu_temp_max_tlimit_threshold>
			<gpu_temp_slow_tlimit_threshold>-2 C</gpu_temp_slow_tlimit_threshold>
			<gpu_temp_max_gpu_tlimit_threshold>0 C</gpu_temp_max_gpu_tlimit_threshold>
			<gpu_target_temperature>N/A</gpu_target_temperature>
		...
		<gpu_power_readings>
			<power_state>P8</power_state>
			<average_power_draw>16.23 W</average_power_draw>
			<instant_power_draw>16.18 W</instant_power_draw>
			<current_power_limit>72.00 W</current_power_limit>
			<requested_power_limit>72.00 W</requested_power_limit>
			<default_power_limit>72.00 W</default_power_limit>
			<min_power_limit>40.00 W</min_power_limit>
...
&check; Pods with GPU requests were isolated from each other as expected.



Deleting test namespace "accelerator-isolation-1774011631"


Namespace deletion took 44s
